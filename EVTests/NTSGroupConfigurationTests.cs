...
namespace cloud.charging.open.EV.Tests
{
    ...
    public class NTSGroupConfigurationTests
    {
        ...
        /// <summary>
        /// What a vehicle asks when its configuration says nothing at all.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Three servers and a quorum of four is a vehicle that can never have
        ...
        public void WhatIsWrittenComesBack()
        {
            ...
            Assert.Multiple(() =>
            {
                ...
                // vehicle wrote reads the way somebody would have written it.
