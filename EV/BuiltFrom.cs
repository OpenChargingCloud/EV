...
namespace cloud.charging.open.EV
{
    ...
    /// <summary>
    /// One assembly this vehicle is running, and the commit it was built from
    ...
    /// <summary>
    /// What this vehicle was built from, read from the assemblies themselves.
    /// </summary>
    /// <remarks>
    ...
    public static class BuiltFrom
    {
        ...
        private static IReadOnlyList<LoadedAssembly> Collect()
        {
            ...
            // vehicle does not reference and would otherwise be missing from its
            ...
            while (queue.Count > 0)
            {
                ...
                foreach (var reference in assembly.GetReferencedAssemblies())
                {
                    ...
                    // depending on how the vehicle was started.
                    try
                    {
