...
/**
 * What the NTS client allows itself when the vehicle has not been told.
 *
 * The vehicle's answer carries the timeout it was configured with, and null
 ...
 * how long this page waits for a test, and the page allows the vehicle
...
/**
 * Where this vehicle reads the time: its time servers, and the rules for
 * believing them.
 *
 ...
 * form told the vehicle a lone host name, which the vehicle read as a group of
...
export const ntsPage: Page = {
    ...
    render({ root }) {
        ...
        const content = shell(root, {
            ...
            title:     'NTS client',
            subtitle:  'Where this vehicle reads the time, and how it knows the answer is real.',
        ...
        /** The list as the vehicle has it, as entries it can be told again. */
        ...
        /** The whole page, from what the vehicle last said. */
        function draw(): void {
            ...
            render(content, html`
                ...
                ${mayChange ? '' : html`
                    <div class="notice">
                        ...
                        servers but not change them. That needs the service or the system administrator role.
                    </div>
                `}
        ...
        /** Whether this vehicle asks anybody at all. */
        function drawSwitch(): void {
            ...
            render(must<HTMLElement>(content, '#nts-switch'), html`
                ...
                <p class="hint">
                    Switched off, this vehicle asks its time servers nothing at all - "Sync now" and the
         ...
         * there are. And the vehicle is told the whole list when this is saved,
        ...
        async function switchTo(on: boolean): Promise<void> {
            ...
            {
                // Back to what the vehicle has, which is not what the box
        ...
        /** Tell the vehicle what the group is held to. */
...
/**
 * Milliseconds the way the vehicle's log writes them: one place after a point,
